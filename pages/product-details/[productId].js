...
const ProductDetails = () => {
  ...
  const categorys = useCartStore((state) => state.categorys);
  const getCategory = categorys.filter(
  ...
  const addToCart = async (id, quantity, product_name, image, price) => {
    ...
    if (token) {
      ...
      if (existingItemIndex !== -1) {
        ...
        cart.push({ id, product_name, price, qty: quantity, image });
  ...
  return (
    <Layout>
      ...
      <section className="product-details-area pt-80 rpt-100">
        <div className="container">
          <div
            className="row  justify-content-between"
            style={{ minHeight: "560px" }}
          >
            <div className="  col-lg-6 col-md-6 col-sm-12 sticky">
              <div className="product-images imgparent">
                <div>
                  {product?.images?.map((img, i) => (
                    <div key={i} onClick={() => setActiveTab(i)}>
                      <img
                        className="imgselct"
                        src={`http://localhost:8000/storage/images/gallery/${img.product_images}`}
                        width={100}
                        height={60}
                ...
                <div className="product-preview-images rmb-55 wow fadeInLeft delay-0-2s">
                  ...
                  >
                    {product.images && (
                      <img
                        src={`http://localhost:8000/storage/images/gallery/${product.images[activeTab]?.product_images}`}
                        alt="Preview"
                      />
                    )}
            ...
            <div className="p-details-tab col-lg-6 col-md-6 col-sm-12">
              <div className="product-details-content mb-30 wow fadeInRight delay-0-2s">
                ...
                <div className="custom-reviews-main">
                  <div className="custom-reviews-main-svg review-first">
                    ...
                    <div>
                      <p className="custom-average-number ml-2 mb-0">
                        {product.rating}
                      </p>
                    </div>
                  </div>
                ...
                <ul className="category-tags pt-10">
                  <li>
                    <b>Category</b>
                    <span>:</span>
                    <a href="#">{getCategory[0]?.category_name}</a>
                  </li>
                  <li>
                    <b>Tags</b>
                    <span>:</span>
