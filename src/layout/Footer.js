    ...
    <div className="container">
      ...
      <div className="row justify-content-center">
        <div className="col-lg-4 col-md-6 order-md-2">
          <div className="footer-widget about-widget text-center">
            <div className="footer-logo mb-30">
              <Link href="/">
                <a>
                  <img style={{maxWidth:'100px'}} src={`http://localhost:8000/storage/images/gallery/${contactDetials.footer_image}`} alt="Logo" />
                </a>
              </Link>
            </div>
            <p>
        ...
        <div className="col-lg-4 col-md-6 order-md-1">
          ...
          <div>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13826.980458558077!2d76.88488740780564!3d29.95800930542613!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390e414c36405d99%3A0xee1e94f6f85e3aae!2sSushant%20City%2C%20Kurukshetra%2C%20Haryana!5e0!3m2!1sen!2sin!4v1715330930401!5m2!1sen!2sin" width="350" height="250" style={{border:"0"}} allowfullscreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
          ...
          <div className="footer-widget contact-widget">
            ...
            <ul>
              ...
              <li>
                ...
                <a href={`tel:${contactDetials.Phone}`}>{contactDetials.Phone}</a>
              </li>
              {contactDetials.alt_phone && (
                <li>
                  <i className="far fa-phone" />
                  <a href={`tel:${contactDetials.alt_phone}`}>{contactDetials.alt_phone}</a>
                </li>
              )}
              
              <li>
                <i className="far fa-envelope" />
                <a href={`mailto:${contactDetials.email}`}>{contactDetials.email}</a>
              </li>
              {contactDetials.alt_email && (
                <li>
                  <i className="far fa-envelope" />
                  <a href={`mailto:${contactDetials.alt_email}`}>{contactDetials.alt_email}</a>
                </li>
              )}
      ...
      <div className="copyright-area pt-25 pb-10">
        <p>© 2024 Sidham Pharmacy. Developed by <span style={{color:"#ff7800",fontWeight:"800"}}>Barcadly Software</span>. All Rights Reserved.</p>
